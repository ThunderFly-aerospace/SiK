...
def settings():
	...
	query(r1, b"ATS1=57")		# SERIAL_SPEED: 57600 baud (GCS side)
	query(r1, b"ATS2=2")		# AIR_SPEED: 2 kbps — max sensitivity
	query(r1, b"ATS3=25")		# NETID (must match balloon)
	query(r1, b"ATS4=5")		# TXPOWER: 5 dBm (RX modem never transmits)
	...
	query(r1, b"ATS16=0")		# RX_TX: 0 = receiver (GCS)
	query(r1, b"AT&W")
	query(r1, b"ATZ")
	time.sleep(0.5)
	query(r1, b"ATO")
